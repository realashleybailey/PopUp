...
public struct PopUpManager {
    ...
    public static func present<Content:View>(isPresented: Binding<Bool>, onDismiss: (() -> Void)? = nil, style: UIUserInterfaceStyle = .unspecified, @ViewBuilder content: @escaping () -> Content) {
        let rootCard = PopUp(isPresented: isPresented, onDismiss: {
